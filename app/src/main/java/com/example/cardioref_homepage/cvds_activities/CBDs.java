...
public class CBDs extends AppCompatActivity {
    VideoView videoView;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_cbds);
        ...
        InputStream inputStream = this.getResources().openRawResource(R.raw.cbd_overview);
        ...
        MediaController mediaController = new MediaController(CBDs.this);
        mediaController.setAnchorView(videoView);
        videoView.setMediaController(mediaController);
        videoView.setVideoURI(Uri.parse("android.resource://" + getPackageName() + "/" + R.raw.cbd_video));

        tv_signs = findViewById(R.id.tv_signs);
        InputStream inputStream1 = this.getResources().openRawResource(R.raw.cbd_symptoms);
        ...
        InputStream inputStream2 = this.getResources().openRawResource(R.raw.cbd_causes);
        ...
        InputStream inputStream3 = this.getResources().openRawResource(R.raw.cbd_diagnosis);
        ...
        InputStream inputStream4 = this.getResources().openRawResource(R.raw.cbd_management);
