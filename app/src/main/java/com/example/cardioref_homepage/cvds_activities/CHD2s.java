...
public class CHD2s extends AppCompatActivity {
    VideoView videoView;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_chd2s);
        ...
        InputStream inputStream = this.getResources().openRawResource(R.raw.chd2_overview);
        ...
        MediaController mediaController = new MediaController(CHD2s.this);
        mediaController.setAnchorView(videoView);
        videoView.setMediaController(mediaController);
        videoView.setVideoURI(Uri.parse("android.resource://" + getPackageName() + "/" + R.raw.chd2_video));

        tv_signs = findViewById(R.id.tv_signs);
        InputStream inputStream1 = this.getResources().openRawResource(R.raw.chd2_symptoms);
        ...
        InputStream inputStream2 = this.getResources().openRawResource(R.raw.chd2_causes);
        ...
        InputStream inputStream3 = this.getResources().openRawResource(R.raw.chd2_diagnosis);
        ...
        InputStream inputStream4 = this.getResources().openRawResource(R.raw.chd2_managment);
