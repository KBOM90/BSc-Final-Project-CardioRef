...
public class DVTs extends AppCompatActivity {
    VideoView videoView;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_dvts);
        ...
        InputStream inputStream = this.getResources().openRawResource(R.raw.dvt_overview);
        ...
        MediaController mediaController = new MediaController(DVTs.this);
        mediaController.setAnchorView(videoView);
        videoView.setMediaController(mediaController);
        videoView.setVideoURI(Uri.parse("android.resource://" + getPackageName() + "/" + R.raw.dvt_video));

        tv_signs = findViewById(R.id.tv_signs);
        InputStream inputStream1 = this.getResources().openRawResource(R.raw.dvt_symptoms);
        ...
        InputStream inputStream2 = this.getResources().openRawResource(R.raw.dvt_causes);
        ...
        InputStream inputStream3 = this.getResources().openRawResource(R.raw.dvt_diagnosis);
        ...
        InputStream inputStream4 = this.getResources().openRawResource(R.raw.dvt_management);
