...
public class CHDs extends AppCompatActivity {
VideoView videoView;
TextView tv_over_view, tv_signs, tv_causes, tv_diagnosis, tv_management;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_chds);
        ...
        InputStream inputStream = this.getResources().openRawResource(R.raw.chd_overview);
        ...
        MediaController mediaController = new MediaController(CHDs.this);
        mediaController.setAnchorView(videoView);
        videoView.setMediaController(mediaController);
        videoView.setVideoURI(Uri.parse("android.resource://" + getPackageName() + "/" + R.raw.chd_));

        tv_signs = findViewById(R.id.tv_signs);
        InputStream inputStream1 = this.getResources().openRawResource(R.raw.chd_symptoms);
        ...
        InputStream inputStream2 = this.getResources().openRawResource(R.raw.chd_causes);
        ...
        InputStream inputStream3 = this.getResources().openRawResource(R.raw.chd_diagnosis);
        ...
        InputStream inputStream4 = this.getResources().openRawResource(R.raw.chd_management);
