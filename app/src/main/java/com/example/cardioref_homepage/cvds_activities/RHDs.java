...
public class RHDs extends AppCompatActivity {
    VideoView videoView;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_rhds);
        ...
        InputStream inputStream = this.getResources().openRawResource(R.raw.rhd_overview);
        ...
        MediaController mediaController = new MediaController(RHDs.this);
        mediaController.setAnchorView(videoView);
        videoView.setMediaController(mediaController);
        videoView.setVideoURI(Uri.parse("android.resource://" + getPackageName() + "/" + R.raw.pdd_video));

        tv_signs = findViewById(R.id.tv_signs);
        InputStream inputStream1 = this.getResources().openRawResource(R.raw.rhd_symptoms);
        ...
        InputStream inputStream2 = this.getResources().openRawResource(R.raw.rhd_causes);
        ...
        InputStream inputStream3 = this.getResources().openRawResource(R.raw.rhd_diagnosis);
        ...
        InputStream inputStream4 = this.getResources().openRawResource(R.raw.rhd_management);
